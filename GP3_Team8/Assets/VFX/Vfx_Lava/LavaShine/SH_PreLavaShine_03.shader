...
Shader "SH_PreLavaShine_03"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 clampResult139 = clamp( ( ( lerpResult78 * i.vertexColor * _Emission ) * lerpResult91 ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
			o.Emission = clampResult139.rgb;
			...
			float clampResult140 = clamp( lerpResult130 , 0.0 , 1.0 );
			o.Alpha = clampResult140;
		}
...
/*ASEBEGIN
Version=16400
-1849;170;1700;922;444.2089;1335.409;1.3;True;True
...
Node;AmplifyShaderEditor.ClampOpNode;139;717.991,-1096.209;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
...
WireConnection;3;2;139;0
WireConnection;3;9;140;0
ASEEND*/
//CHKSM=7565304E7EA511DC3298F1F387F073F8CA850E49